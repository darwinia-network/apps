...
export const Disclaimer = () => {
  ...
  return (
    <CSSTransition appear timeout={300} in={isVisible} unmountOnExit classNames="fade-disclaimer" nodeRef={nodeRef}>
      <div className="fixed bottom-[10px] right-0 z-10 w-full lg:bottom-5">
        <div className="container mx-auto flex justify-end">
          <div
            className="flex max-w-[400px] flex-col gap-[10px] border border-primary bg-bg-component p-5"
            ref={nodeRef}
          >
            <p className="text-light text-xs text-white">
              ...
              Ecosystem, and is not responsible for any damages or losses resulting from the use of, or inability to
              use, these Dapps.
            </p>
            <button
