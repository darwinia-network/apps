...
export const PortalItem = ({ meta }: { meta: PortalMeta }) => {
  ...
  return (
    <>
      ...
      {/* pc */}
      <div className="card-filp hidden shadow-lg lg:block">
        ...
        <div className="front flex flex-col items-center justify-center bg-bg-component p-3">
